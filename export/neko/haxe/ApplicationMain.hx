...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("GAMES-2019-T1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("GAMES-2019-T1", null, 900, 750);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "GAMES-2019-T1";
		app.meta["name"] = "GAMES-2019-T1";
